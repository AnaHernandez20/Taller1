...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pais de un atleta especifico");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muestra al usuario el pais del atleta que buscó
	 */
	
	public void ejecutarBuscarPaisAtleta() {
		
		String nombreBuscar = input("Por favor ingrese el nombre del atleta que desea buscar");
		nombreBuscar = nombreBuscar.toLowerCase();
		
		String respuesta = calculadora.darPaisAtleta(nombreBuscar);
